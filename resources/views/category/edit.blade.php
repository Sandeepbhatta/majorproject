                        ...
                        <div class="modal-dialog " >
                            ...
                            <div class="modal-content ">
                                <div class="modal-header" >
                                    <h5 class="modal-title" id="model-title" style="Color:Black">Edit category</h5>
                                    <!-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> -->
                                </div>
                                <div class="modal-body ">
                                    <div class="form-group md-4">
                                        <label for="name" class="form-label">category Name</label>
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"   name="name" placeholder="Name" value="{{old('name',$category->name)}}" style="background:white;">
                                        @error('name')
                                    ...
                                    <div class="form-group md-4">
                                        ...
                                        <input type="text" size="100"class="form-control @error('date') is-invalid @enderror"  name="description" placeholder="Description" value="{{old('description',$category->description)}}" style="background:white;">
                                        @error('description')
                                        <p class="valid-feedback">{{$message}}</p>
                                        @enderror
                                    </div>
